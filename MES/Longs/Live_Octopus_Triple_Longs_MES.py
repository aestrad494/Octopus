...
if __name__ == '__main__':
    ...
    live_octopus.run_strategy(contracts=6, stop_1=3, target_1=3, target_2=1, trailing_1=0.8, stop_2=6, target_3=2, target_4=10, trailing_2=0.9,
                          stop_3=13, target_5=11, target_6=26, trailing_3=0.9, periods=periods, tempos=tempos, init=init, final=final)
