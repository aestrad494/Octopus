...
class LiveOctopus(Live, Indicators):
    ...
    def run_strategy(self, contracts, stop_1, target_1, target_2, trailing_1, stop_2, target_3, target_4, trailing_2, stop_3, target_5, target_6, trailing_3, periods, tempos, init, final):
        ...
        if self.operable:
            ...
            # Defining mu and std
            mu_feat_1 = mu_1.T[feat_1]; std_feat_1 = std_1.T[feat_1]
            mu_feat_2 = mu_2.T[feat_2]; std_feat_2 = std_2.T[feat_2]
            mu_feat_3 = mu_3.T[feat_3]; std_feat_3 = std_3.T[feat_3]
...
if __name__ == '__main__':
    ...
    live_octopus.run_strategy(contracts=6, stop_1=2, target_1=2, target_2=1, trailing_1=0.9, stop_2=3, target_3=3, target_4=6, trailing_2=0.3,
                          stop_3=10, target_5=4, target_6=12, trailing_3=0.8, periods=periods, tempos=tempos, init=init, final=final)
